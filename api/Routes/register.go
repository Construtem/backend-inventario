...
func RegisterRoutes(router *gin.Engine, db *gorm.DB) {
	...
	api.GET("/stock-sucursal/productos-inactivos", Handlers.GetProductosInactivosHandler(db))
	...
	api.POST("despachos/:id/ficha", Handlers.RecibirFichaDespachoHandler(db))
